...
export const Sidebar = () => {
  ...
  const onDragStart = (event: any, nodeType: string, text: string, code: string) => {
  ...
  return (
    <div className="w-60 flex-none h-full overflow-y-auto flex flex-col items-start p-2 border-r border-gray-200">
      ...
      <div className="flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer"  onDragStart={(event) =>
      ...
      <div
        ...
        onDragStart={(event) =>
          onDragStart(event, "output", "Turn 15 degrees anticlockwise", "anticlockwise")
        }
        draggable
      >
        {"Turn "}
