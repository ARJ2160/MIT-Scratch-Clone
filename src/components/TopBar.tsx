...
const TopBar = () => {
  ...
  return (
    <div className="bg-white flex justify-between items-center">
      ...
      <div className='flex'>
      <div className='w-14 h-14 bg-green-600 hover:text-white flex items-center justify-center border-2 rounded-lg' onClick={onGreenFlagClick}>
      <Icon name="flag" size={15} className="mx-2" />
      </div>
      <div className='w-14 h-14 bg-red-600 hover:text-white flex items-center justify-center border-2 rounded-lg' onClick={onRedFlagClick}>
